...
TASK = 3  # choose from 3.1, 3.2, 3.3
...
neural_network_or_random_forest = (
    "random_forest"  # Change to "random_forest" to use Random Forest models
)
...
def main():
    ...
    sim = pb.SimInterface(
        conf_file_name, conf_file_path_ext=root_dir
